    ...
    var levelData = [
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 400, y: groundY - 310 },
          { type: "enemy", x: 800, y: groundY - 300 },
          { type: "reward", x: 300, y: groundY - 300 },
          { type: "reward", x: 400, y: groundY - 300 },
          { type: "reward", x: 500, y: groundY - 300 },
          { type: "reward", x: 600, y: groundY - 300 },
          { type: "reward", x: 2000, y: groundY - 300 },
          { type: "reward", x: 2100, y: groundY - 300 },
          { type: "reward", x: 2200, y: groundY - 300 },
          { type: "reward", x: 2300, y: groundY - 300 },
          { type: "reward", x: 2400, y: groundY - 300 },
          { type: "marker", x: 3000, y: groundY - 300, color: "yellow" },
        ],
      },
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 600, y: groundY - 300 },
          { type: "reward", x: 600, y: groundY - 300 },
          { type: "marker", x: 3000, y: groundY - 300, color: "white" },
        ],
      },
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 600, y: groundY - 300 },
          { type: "reward", x: 600, y: groundY - 300 },
          { type: "marker", x: 3000, y: groundY - 300, color: "green" },
        ],
      },
    ];
